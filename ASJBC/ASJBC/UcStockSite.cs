...
namespace ASJ.BCOR
{
    ...
    public partial class UcStockSite : BaseUserControl
    {
        ...
        public void BindGrdLookUpEdit()
        {
            ...
            strsql.Add("SELECT TKEY,EMPLOYEE_NAME,EMPLOYEE_CODE  from BCOR_EMPLOYEE where  FLAG = 1");//库位负责人
            strsql.Add("SELECT TKEY,STOCK_NAME,STOCK_CODE  from BCOR_STOCK where  FLAG = 1");//所属库房
            //strsql.Add("SELECT TKEY,STOCK_AREA_NAME,STOCK_AREA_CODE from BCOR_STOCK_AREA where  FLAG = 1");//所属库区
            ...
            //Control.Add(txtSTOCK_TKEY);//所属库区
