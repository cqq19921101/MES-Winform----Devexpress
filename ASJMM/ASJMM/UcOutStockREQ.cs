...
namespace ASJMM
{
    ...
    {
        //实例化帮助类
        ASJMM_OutStock MHelper = new ASJMM_OutStock();
        ...
        {
            ds = MHelper.OutStockLoadREQ(TKEY);//FrmDataLoad
        ...
        public DataSet SaveFunction()
        {
            ...
            if (ds.Tables["MMSMM_OUTSTOCK_REQ"].Rows.Count == 0) MHelper.InsertNewRowForDatatable(ds, "MMSMM_OUTSTOCK_REQ");
        ...
        {
            MHelper.BindDataSourceForGridControl(GridItem, GrvOutStockREQ, "MMSMM_OUTSTOCK_REQ_D", TKEY);
        }
        ...
        public void BindGrdLookUpEdit()
        {
            ...
            Control.Add(txtTO_DEPT_TKEY);//目标部门
            Control.Add(txtRECEIVE_PERSON);//目标收货人
            Control.Add(txtSOURCE_STOCK_TKEY);//来源库房
            Control.Add(txtTO_STOCK_TKEY);//目标库房
            MHelper.BindGridLookUpEdit_OutStock(Control);
        }
        ...
        public void BindReGridLookUpEdit()
        {
            ...
            MHelper.BindReGridLookUpEdit_OutStock(Control);
        }
        ...
        public void BindReLookUpEdit()
        {
            ...
            MHelper.BindReLookUpEdit_OutStock(Control);
        }
