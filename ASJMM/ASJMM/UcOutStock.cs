...
namespace ASJMM
{
    ...
    public partial class UcOutStock : BaseUserControl
    {
        ...
        {
            ds = MHelper.OutStockLoad(TKEY);//FrmDataLoad
        ...
        public DataSet SaveFunction()
        {
            ...
            if (ds.Tables["MMSMM_OUTSTOCK"].Rows.Count == 0) MHelper.InsertNewRowForDatatable(ds, "MMSMM_OUTSTOCK");
        ...
        {
            MHelper.BindDataSourceForGridControl(GridItem, GrvOutStock, "MMSMM_OUTSTOCK_D", TKEY);
        }
        ...
        public void BindGrdLookUpEdit()
        {
            ...
            Control.Add(txtTO_PERSON);//目标收货人
