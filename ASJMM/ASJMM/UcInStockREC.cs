...
namespace ASJMM
{
    ...
    public partial class UcInStockREC : BaseUserControl
    {
        ...
        {
            ds = MHelper.InStockRECLoad(TKEY);//FrmDataLoad
        ...
        public DataSet SaveFunction()
        {
            ...
            try
            {
                ...
                if (ds.Tables["MMSMM_INSTOCK_REC"].Rows.Count == 0) MHelper.InsertNewRowForDatatable(ds, "MMSMM_INSTOCK_REC");
        ...
        {
            MHelper.BindDataSourceForGridControl(GridItem, GrvInStockREC, "MMSMM_INSTOCK_REC_D", TKEY);
        }
        ...
        public void BindGridLookUpEdit()
        {
            ...
            MHelper.BindGridLookUpEdit_InStockREC(Control);
        }
        ...
        public void BindReGridLookUpEdit()
        {
            ...
            MHelper.BindReGridLookUpEdit_InStockREC(Control);
        }
        ...
        public void BindReLookUpEdit()
        {
            ...
            MHelper.BindReLookUpEdit_InStockREC(Control);
        }
